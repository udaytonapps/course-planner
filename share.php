...
if (!$shares) {
    ...
    foreach ($shares as $share) {
        ...
        if ($share["can_edit"]) {
            echo '<a href="#" class="plan-link" title="User can edit this plan"><span class="fas fa-cube" aria-hidden="true"></span><span class="sr-only">Make read-only</span></a>';
        } else {
            echo '<a href="#" class="plan-link" title="User has read-only access to this plan"><span class="fas fa-lock" aria-hidden="true"></span><span class="sr-only">Allow editing</span></a>';
        }
